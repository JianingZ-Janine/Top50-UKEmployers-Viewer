...
function BehaviorQuestions() {
  return (
    <div className="behavior-questions-container">
      <h2>Preparing for Behavioral Interview Questions</h2>
      <p>Behavioral questions are designed to assess your past behavior in specific situations to predict your future performance. They often start with phrases like "Tell me about a time when..." or "Give me an example of..."</p>

      <h3>STAR Method for Answering Behavioral Questions</h3>
      <p>The STAR method is a structured way of responding to behavioral interview questions by discussing the:</p>
      <ul>
      ...
      <h3>Common Behavioral Question Categories:</h3>
      <ul>
        <li>Teamwork</li>
        <li>Leadership</li>
